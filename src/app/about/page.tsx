  ...
  return (
    <>
      ...
      <main className="relative z-10 mx-auto max-w-[720px] px-6 pt-16 pb-24 lg:px-20 lg:pt-24">
        ...
        <p className="word-keep-all mb-10 text-justify font-kr text-sm leading-[1.8] font-light text-fg/70">
        ...
        <div className="mb-10 grid grid-cols-2 gap-5 border-t border-border pt-[30px]">
        ...
        <div className="flex flex-col gap-2 border-t border-border pt-6 font-kr text-sm text-fg/60">
          <div className="flex gap-3">
            <span className="min-w-[70px] text-[10px] font-medium tracking-[0.15em] text-accent uppercase">
              대표자
            </span>
