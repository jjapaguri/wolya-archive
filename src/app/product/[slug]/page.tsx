    ...
    <>
      ...
      <main className="relative z-10 mx-auto max-w-[1000px] px-6 pt-16 pb-24 lg:px-20 lg:pt-24">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,480px)_1fr] lg:gap-16">
          <div className="relative h-[420px] w-full bg-accent-dim lg:h-[560px]">
            <Image
              src={product.image}
              alt={product.name}
              fill
          ...
          <div>
            <div className="mb-3 font-sans text-[10px] tracking-[0.2em] text-accent uppercase">
              {product.tag}
            </div>
            <h1 className="word-keep-all mb-2 font-maruburi text-2xl font-medium text-fg lg:text-3xl">
              {product.name}
            </h1>
            <p className="word-keep-all mb-8 font-kr text-sm font-light text-fg/70">{product.hook}</p>
